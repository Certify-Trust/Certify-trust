...
// import IMG from "@/public/successCert.svg";
...
//       <div className="mt-4 flex flex-col gap-5 bg-[#F4F5FB] min-[482px]:flex-row">
//         <Image src={IMG} alt="" />
//       </div>
//     </div>
//   );
...
const ProfileIcon = ({ size = 40 }: { size?: number }) => (
  ...
  >
    <IoPerson size={size * 0.65} className="text-white" />
  </div>
);
...
const CertificateSuccess = () => {
  ...
  return (
    <div className="min-h-[40vh] rounded-md bg-gray-100">
      {/* ── Top Bar ── */}
      ...
      <div className="flex items-center justify-between bg-white px-6 py-4 shadow-sm">
        ...
        <div className="flex items-center gap-4">
          ...
          <a href="#" className="text-sm font-medium text-[#5324FB]">
            Login
          </a> */}
        </div>
      </div>
      ...
      {/* ── Certificate Image ── */}
      {/* <div className="flex flex-wrap justify-center gap-6 bg-gray-200 px-6 ">
        {formData.certificateImage && (
          <img
            src={formData.certificateImage}
            alt="certificate"
            className="max-h-[400px] w-full max-w-2xl rounded-lg object-contain shadow-sm"
          />
        )}
        {formData.badgeImage && (
          <img
      ...
      {/* ── Main Content ── */}
      <div className="mx-auto mt-12 max-w-4xl px-6 pb-12">
        <div className="flex flex-col gap-6 lg:flex-row">
          ...
          <div className="flex-1 space-y-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-[#344054]">
                {formData.issuerName || "Certifytrusts"}
              </span>
              <ExternalLink size={20} />
            </div>

            {/* <h1 className="text-[24px] text-[#101828]">
              {formData.issuerName || "Sani Chris"}
            </h1> */}
            ...
            {/* <a
              href="#"
              className="text-[14px] text-[#5324FB] underline hover:underline"
            >
            ...
            <div className="mt-4 flex items-center gap-3">
              <ProfileIcon size={40} />
              <span className="text-[20px] text-[#101828]">
                {/* {formData.displayName} */}
                Sani Chris
              </span>
            </div>
            <a href="#" className="block text-[14px] text-[#5324FB] underline">
              ...
              <div className="space-y-2">
                ...
                <div className="flex flex-wrap gap-2">
                  {formData.skills.map((s, i) => (
                    <span
                      key={`${s}-${i}`}
                      className="rounded bg-[#E8E8E8] px-3 py-1 text-xs text-[#344054]"
                    >
                      {s}
                    </span>
                  ))}
            ...
            <div className="flex gap-12">
              <div>
                <p className="text-xs font-medium tracking-wide text-[#667085] uppercase">
                  Issued On
                </p>
            ...
            <div className="space-y-2">
              ...
              <div className="flex w-fit items-center gap-3 rounded-lg border border-[#D0D5DD] px-4 py-2">
          ...
          {/* ── Right ── */}
          <div className="w-full space-y-4 lg:w-[362px]">
            {/* Share */}
            <div className="space-y-3 rounded-lg bg-[#1E1B4B] p-5">
            ...
            {/* More about Issuer */}
            <div className="space-y-3 rounded-lg border border-[#EAECF0] bg-white p-5">
              <p className="text-sm font-semibold text-[#101828]">
            ...
            {/* More credentials */}
            <div className="flex h-fit w-[360px] flex-col space-y-3 rounded-lg border border-[#EAECF0] bg-white p-5">
              <p className="text-sm font-semibold text-[#101828]">
                Blockchain verification hash
              </p>

              <p className="w-full text-sm font-semibold text-gray-500">
                0x8f3c9d71a4be2c6f91d0e5ab7c42f8d1e6a93bc4
              </p>
              <a href="#" className="text-sm text-[#5324FB] underline">
                Velocity Network
              </a>
            </div>
          </div>
