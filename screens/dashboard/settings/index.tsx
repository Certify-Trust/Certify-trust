...
import BrandSettings from "@/screens/groups/tabs/BrandSettings";
import RecipientSupport from "@/screens/groups/tabs/RecipientSupport";
import MarketMyCourses from "@/screens/groups/tabs/MarketmyCourses";
...
const GeneralInformation = () => {
  ...
  return (
    <FormProvider {...methods}>
      <section className="space-y-5 rounded-lg border border-gray-300 p-4">
        <div>
          <h2 className="text-base font-semibold text-[#101828]">
            General Information
          </h2>
          <p className="text-sm text-[#667085]">
            Set up the details for general information
          </p>
        </div>
        ...
        <div>
          ...
          <p className="text-xs text-[#667085]">
            Name of the credential issuer displayed on credential
          </p>
        </div>
        ...
        <div className="space-y-1.5">
          ...
          <p className="text-xs text-[#667085]">
            A description for your organization
          </p>
          <RichTextEditor
            value={description}
        ...
        <Button className="h-10 px-8 text-white hover:bg-[#6941C6]">
          Save
        </Button>
      </section>
    </FormProvider>
      ...
      <section className="space-y-5 rounded-lg border border-gray-300 p-4">
        <div>
          ...
          <p className="mt-2 text-sm text-[#667085]">
            Link your social channels to your issuer page
          </p>
        </div>
  ...
  return (
    <section className="space-y-5 rounded-lg border border-gray-300 p-4">
      <div>
        ...
        <p className="text-sm text-[#667085]">
          Integrate with Certifytrusts using our built-in API
        </p>
      </div>
      ...
      <div className="space-y-2">
        ...
        <div className="flex items-center gap-2 rounded-lg border border-[#5324FB] bg-[#F8F7FF] px-4 py-3">
          ...
          <p className="flex-1 text-sm text-[#667085]">
            To access API Keys management, purchase the addon in the new Launch
            plan.{" "}
            <a
              href="#"
              className="inline-flex items-center gap-1 font-medium text-[#7F56D9] hover:underline"
            >
        ...
        <button
          disabled
          className="mt-1 cursor-not-allowed rounded-lg border border-[#EAECF0] px-4 py-2 text-sm text-[#98A2B3]"
        >
          Manage API Keys
        </button>
      </div>
      ...
      <a
        href="#"
        className="inline-flex items-center gap-1 text-sm font-medium text-[#7F56D9] hover:underline"
      >
